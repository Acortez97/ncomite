...
export default function RegistroPagos() {
    ...
    useEffect(() => {
        fetch(API_SELECT_USUARIOS, {
            ...
            body: JSON.stringify({
                ...
                table: "usuarios", orderBy: 'Nombre ASC'
            }),
        })
            .then((res) => res.json())
            .then((data) => {
    ...
    const guardarPago = async () => {
        ...
        const res = await fetch(API_INSERT_PAGO, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    return (
        <div style={containerStyle}>
            <h2 style={{ textAlign: "center" }}>Registro de Pagos</h2>
